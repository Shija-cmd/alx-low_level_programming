...
/**
 * set_spair - mallocs a key or value pair to the sorted hash table.
...
/**
 * shash_table_print - prints key or value pairs in sorted hash table order.
...
/**
 * shash_table_print_rev - prints sorted key or value pairs in reverse.
 * @ht: the sorted hash table.
 */
